...
(* Entities								*)
(*----------------------------------------------------------------------*)
val primEntity = (Entity.Sig, Id.fromString "PRIM", Level.rootLevel)
val datatypeEntity = (Entity.Str, Id.fromString "Datatypes", Level.rootLevel)
val generalEntity = (Entity.Str, Id.fromString "General", Level.rootLevel)
val primUtilsEntity = (Entity.Str, Id.fromString "PrimUtils_", Level.rootLevel)
